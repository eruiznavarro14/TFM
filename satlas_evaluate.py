...
from satlas_utils import compute_metrics, plot_confusion_matrix, save_metrics_to_file
...
def main():
    ...
    # 📦 Cargar modelo SATLAS
    model = get_satlas_model(num_classes=10).to(device)
    model.load_state_dict(torch.load(args.model_path, map_location=device))
    print(f"✅ Modelo SATLAS cargado desde {args.model_path}")
    ...
    save_metrics_to_file(metrics, filename="satlas_metrics.txt")
